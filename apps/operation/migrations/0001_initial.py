    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_type', models.IntegerField(choices=[(1, '课程'), (2, '课程机构'), (3, '课程名')], default=1, verbose_name='收藏类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='消息接收时间')),
            ],
            options={
                'verbose_name': '用户消息',
